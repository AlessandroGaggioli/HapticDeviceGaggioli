...
int main (int argc,char **argv) {
    ...
    pos_initial[0] = 0.306913 ; 
    pos_initial[1]= 9.13102e-06; 
    pos_initial[2]= 0.590185 ; 
    pos_initial[3] =1 ; 
    pos_initial[4] =0.000205374 ; 
    pos_initial[5] =-0.000503117 ; 
    pos_initial[6] =5.7995e-06 ; 
        ...
        if(!data) {
           ...
           /* fk_srv.request.reference_joints.position=joint_pos_initial ;   
            ...
            //Calcolo dei Coefficienti della Polinomiale 
                ...
                period = distance_max(abs(distance_x),abs(distance_y),abs(distance_z)) / Vmax; //periodo = distanza max / Vmax 

                std::cout <<distance_x <<" " <<distance_y <<" " <<distance_z <<"  max: " <<distance_max(abs(distance_x),abs(distance_y),abs(distance_z)) <<" periodo: " <<period ; 
