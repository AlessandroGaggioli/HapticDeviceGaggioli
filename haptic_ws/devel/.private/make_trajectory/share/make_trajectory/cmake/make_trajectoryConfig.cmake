...
if(NOT "/home/student/haptic_ws/src/make_trajectory/include " STREQUAL " ")
  set(make_trajectory_INCLUDE_DIRS "")
  set(_include_dirs "/home/student/haptic_ws/src/make_trajectory/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'make_trajectory' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/haptic_ws/src/make_trajectory/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/haptic_ws/devel/.private/make_trajectory/lib;/home/student/haptic_ws/devel/lib;/home/student/turtle_ws/devel/lib;/opt/ros/noetic/lib)
